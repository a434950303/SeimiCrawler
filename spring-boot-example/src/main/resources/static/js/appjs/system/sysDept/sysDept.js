				...
				columns : [
					...
					},
					{
						...
						formatter : function(item, index) {
							...
							if(item.delFlag==1){
								a = '<a class="btn btn-primary btn-sm ' + s_add_h + '" href="#" title="增加下級"  mce_href="#" onclick="add(\''
								+ item.deptId
								+ '\')"><i class="fa fa-plus"></i></a> ';
							}else
							{
								a = '<a disabled="true" class="btn btn-primary btn-sm ' + s_add_h + '" href="#" title="增加下級"  mce_href="#" ><i class="fa fa-plus"></i></a> ';
							}
