...
import cn.wanghaomiao.seimi.ipproxy.htmlparse.URLFecter;
import cn.wanghaomiao.seimi.ipproxy.ipfilter.IPFilter;
import cn.wanghaomiao.seimi.ipproxy.ipfilter.IPUtils;
...
public class MyTimeJob extends TimerTask {
    ...
    public void run() {
        ...
        //自定义 改写成从西瓜代理网上爬取代理IP
        ipMessages = URLFecter.urlParseFromXigua(ipMessages,1000);
